    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" @click="updatePokemon" class="btn btn-primary">Update pokemon</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods:{
        getPokemonData(pokemonID){
            axios.get(`http://localhost:3000/api/contacts/${pokemonID}`).then(res=>{
        ...
        updatePokemon() {
            var mythis=this;
            axios.put(`http://localhost:3000/api/contacts/${this.pokemonID}`, this.model.contacts)
            .then(res => {
                console.log(res.data)
